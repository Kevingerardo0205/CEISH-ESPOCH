...
export abstract class IUserRepository {
  ...
  abstract save(user: Partial<UserOrmEntity>, manager?: any): Promise<UserOrmEntity>;
  abstract update(id: number, data: Partial<UserOrmEntity>, manager?: any): Promise<void>;
