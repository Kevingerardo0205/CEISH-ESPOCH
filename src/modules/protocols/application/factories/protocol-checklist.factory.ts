...
export class ProtocolChecklistFactory {
  private readonly requirementsMap: Record<StudyTypeCode, RequirementTemplate[]> = {
    [StudyTypeCode.IO]: [
      { code: 'REQ_A', name: 'Solicitud de evaluación (Anexo 1)' },
      { code: 'REQ_B', name: 'Formulario de presentación del protocolo (Anexo 2)' },
      { code: 'REQ_C', name: 'Consentimiento informado' },
      { code: 'REQ_D', name: 'Consentimiento colectivo/comunitario (si aplica)' },
      { code: 'REQ_E', name: 'Instrumentos de investigación (fichas, encuestas, etc.)' },
      ...
      { code: 'REQ_I', name: 'Declaración de responsabilidad del IP (Anexo 4)' },
    ...
    [StudyTypeCode.EI]: [
      ...
      { code: 'REQ_E', name: 'Consentimiento colectivo/comunitario (si aplica)' },
      ...
      { code: 'REQ_J', name: 'Declaración de responsabilidad del IP (Anexo 4)' },
    ...
    [StudyTypeCode.EC]: [
      { code: 'REQ_A', name: 'Carta de solicitud de evaluación suscrita por IP (Anexo 6)' },
      { code: 'REQ_B', name: 'Declaración de responsabilidad del IP (Anexo 4)' },
      ...
      { code: 'REQ_G', name: 'Formulario de consentimiento informado (Anexo 3)' },
      ...
      { code: 'REQ_N', name: 'Información de seguridad del fármaco experimental' },
      { code: 'REQ_O', name: 'Carta de aprobación del Comité de ética del país del patrocinador' },
