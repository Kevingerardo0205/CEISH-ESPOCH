...
export class AggressiveFixDocumentCodes1778840000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'UPDATE catalogos.tipos_documento SET nombre = TRIM(nombre), codigo_anexo = TRIM(codigo_anexo)',
    );
    ...
    const mapping = {
      ...
      'Instrumentos de Investigación (Fichas, encuestas, manuales)':
        'INSTRUMENTOS_INV',
      ...
      'Consentimiento Colectivo o Comunitario (Líder/Asamblea)':
        'CONSENTIMIENTO_COMUNITARIO',
      ...
      'Protocolo de Investigación (Original y Castellano)':
        'PROTOCOLO_COMPLETO',
      'Ficha Descriptiva de Ensayos Clínicos': 'FICHA_DESCRIPTIVA',
      'Manual del Investigador (Buenas Prácticas Clínicas)': 'MANUAL_INV',
      'Procedimientos e Instrumentos de Reclutamiento y Recolección':
        'INSTRUMENTOS_REC',
      'Certificados de Capacitación y Experiencia (Bioética)':
        'CERT_CAPACITACION',
      'Registro SENESCYT del Investigador Principal': 'REGISTRO_SENESCYT',
      'Información sobre Seguridad del Fármaco Experimental':
        'INFO_SEG_FARMACO',
      ...
      'Carta de Aprobación del Comité de Ética del País de Origen':
        'APROBACION_PAIS_ORIGEN',
    };
